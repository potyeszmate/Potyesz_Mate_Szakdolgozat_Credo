...
import { LoansIconMapping, LoansProviders } from './RecurringComponentConstants';
...
const RecurringLoanInput: React.FC<RecurringTransactionInputProps> = ({ onAddRecurringTransaction, initialRecurringTransaction, conversionRate, currency, selectedLanguage, onDeleteRecurringTransaction, onClose }) => {
  ...
  const filteredProviders = LoansProviders.filter((provider: any) =>
        ...
        <View style={RecurringInputStyles.inputWrapper}>
          <TouchableOpacity style={RecurringInputStyles.inputContainer} onPress={() => setModalProviderVisible(true)}>
            <View style={RecurringInputStyles.iconContainer}>
              <Image
                source={selectedProvider !== null ? LoansIconMapping[selectedProvider] : selectProviderIcon}
              ...
              <KeyboardAvoidingView style={RecurringInputStyles.contentContainer} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
                ...
                <ScrollView contentContainerStyle={RecurringInputStyles.scrollViewContent}>
                  {filteredProviders.map((provider: any, index: any) => (
                    ...
                    >
                      <Image source={LoansIconMapping[provider.label]} style={RecurringInputStyles.providerIcon} />
