...
import RecurringLoanInput from '../../../components/Recurrings/RecurringLoanInput';
import { RecurringStyles } from '../ExpensesSytles';
import { languages } from '../../../commonConstants/sharedConstants';
import { loansIconMapping } from '../ExspensesConstants';
  ...
  return (
    <View style={RecurringStyles.container}>
            ...
            return (
              <TouchableOpacity style={RecurringStyles.transactionItem} onPress={() => handleEditIconClick(item)}>
                <View style={RecurringStyles.transactionIcon}>
                  <Image source={loansIconMapping[item.name]} style={RecurringStyles.iconImage} />
                </View>
                <View style={RecurringStyles.transactionInfo}>
                  ...
                  <View style={RecurringStyles.categoryDateContainer}>
                    <Text style={[RecurringStyles.transactionCategory, { color: '#888' }]}>{languages[selectedLanguage][item.category]}</Text>
      ...
      >
        ...
        <Text style={RecurringStyles.addButtonText}>{languages[selectedLanguage].addLoan}</Text>
      </TouchableOpacity>
      ...
      >
        <View style={RecurringStyles.deleteModalContainer}>
          <View style={RecurringStyles.deleteModalContent}>
            <Text style={RecurringStyles.deleteModalText}>{languages[selectedLanguage].deleteLoanModalText}</Text>
            <View style={RecurringStyles.deleteModalButtons}>
              ...
              <TouchableOpacity onPress={deleteRecurringTransactionHandler} style={[RecurringStyles.deleteModalButton, RecurringStyles.deleteModalButtonYes]}>
